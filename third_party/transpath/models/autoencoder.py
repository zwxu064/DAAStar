...
class PathLogger(pl.Callback):
    def __init__(self, val_batch, num_samples=20, mode='f'):
        ...
        map_design = val_batch['maps'][:num_samples]
        start = val_batch['starts'][:num_samples]
        goal = val_batch['goals'][:num_samples]
        gt_hmap = val_batch['ppm'][:num_samples]
...
class DemPathLogger(pl.Callback):
    def __init__(self, val_batch, num_samples=20):
        ...
        dem = val_batch['dem'][:num_samples]
        rgb = val_batch['rgb'][:num_samples]
        sg = val_batch['sg'][:num_samples]
        focal = val_batch['ppm'][:num_samples]
